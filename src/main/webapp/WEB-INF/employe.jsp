...
<body>
  <div class="bslf">
    <form action="" method="post">
      ...
      <div class="form-group">
        <input type="text" class="form-control" placeholder="nom" required="required" name="nomComplet">
      </div>
      <div class="form-group">
         <input type="number" class="form-control" placeholder="téléphone" required="required" name="tel">
       </div>
       <div class="form-group">
         <input type="date" class="form-control" placeholder="Date" required="required" name="ddn">
       </div>
       <div class="form-group">
